...
describe("LinkedList", function () {
    ...
    describe("contains() method", function() {
        it("contains a given comparison function", function() {
            linkedList.add(1);
            linkedList.add(5);
            linkedList.add(3);

            linkedList.sort((a,b)=> { return a - b });
            assert.equal(linkedList.contains(0, 3), -1);
            assert.equal(linkedList.contains(5, 3), -1);
            assert.equal(linkedList.contains(3, 3), -1);
        });
    });
